# Ersatz [`exec(3)`](https://man7.org/linux/man-pages/man3/exec.3.html) for [Node JS](https://nodejs.org) [![npm version](https://img.shields.io/npm/v/pseudoexec)](https://www.npmjs.com/package/pseudoexec)
